...
public class TeamManagement implements ITeamManagement {
	...
	/**
	 * The function tries to add given channel to the team channels if it is possible
	 *
	...
	/**
	 * The function tries to add given academician to the team owners if it is possible
	 *
	...
	/**
	 * The function tries to remove given channel from the team channels if it is possible, invoking removeItem method. 
	 ...
	 * If removing process is not successfull, return the given error message.
     *
     * @param item given item to remove from the given container
	 * @param container given container list
	 * @param error error message to print if removing process is not successfull.
	 */
