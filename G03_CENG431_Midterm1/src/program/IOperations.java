...
public interface IOperations {
	...
	/*
	 * The function creates a team with the user's given name and id inputs, if user is authorized to that process 
	...
	/*
	 * The function removes a team which is selected from menu by user, if user is authorized to that process 
	 * @param loggedInUser : user which is logged in
	 * @param teams : objects of readTeams from file
	 * @throws UnauthorizedUserOperationException
	 */
	...
	/*
	 * The function add a meeting channel / private channel which is created according to
	 * given name and given date gotten from user, if user is authorized to that process 
	 * @param loggedInUser : user which is logged in
	...
	/*
	 * The function remove a meeting channel / private channel which is selected from menu by user,
	 *  if user is authorized to that process 
	 * @param loggedInUser : user which is logged in
	 * @param team : selected team
	 * @throws UnauthorizedUserOperationException
	 */
	...
	/*
	 * The function returns a string to print team update operation and gets an input from user
	...
	/*
	 * The function prints a menu to update a meeting channel / private channel which is selected from menu by user,
	 *  if user is authorized to that process 
	 * @param loggedInUser : user which is logged in
	 * @param team : selected team
	 * @throws UnauthorizedUserOperationException
	...
	/*
	 * The function add a selected member to a selected team if loggedInUser is authorized to that process 
	 * @param loggedInUser : user which is logged in
	 * @param team : selected team
	...
	/*
	 * The function remove a selected member from a selected team if loggedInUser is authorized to that process 
	 * @param loggedInUser : user which is logged in
	 * @param team : selected team
	 * @throws UnauthorizedUserOperationException
	 */
	...
	/*
	 * The function assign a selected instructor/teaching assistant as team owner to selected team if loggedInUser is authorized to that process 
	 * @param loggedInUser : user which is logged in
	 * @param team : selected team
	 * @throws UnauthorizedUserOperationException
	 */
	...
	/*
	 * The function remove a selected instructor/teaching assistant from team owner for selected team if loggedInUser is authorized to that process 
	 * @param loggedInUser : user which is logged in
	 * @param team : selected team
	 * @throws UnauthorizedUserOperationException
	 */
