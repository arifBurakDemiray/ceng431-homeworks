...
public interface IFileIO {
	...
	/**
	 * This function reads the teams of the system, file should have a format
	 * like Team Name,Team ID,Default Channel,Default Meeting Day and Time,Meeting Channel,Meeting Day and Time,Participant(s) ID
	 * and all other channels comes to the end in order Meeting Channel,Meeting Day and Time,Participant(s) ID
	 * Meeting day and time should have a pattern like "DAY HH:MM PERIOD" example "Monday 09:45 AM"
	 * next team should be in a newline 
	 ...
	 * User format should have a pattern like User Type,User Name,User ID,Email,Password,Team ID1,Team ID2,...
	 * next user should be in a newline
