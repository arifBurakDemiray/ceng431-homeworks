...
public class ChannelContainer extends Container<Channel> {
	...
	/*
	 * The function of the abstract function returns an error about not supporting that process
	...
	/*
	 * The function search the given name belongs to the any channel or not. If given name belongs to a channel, it returns the channel
